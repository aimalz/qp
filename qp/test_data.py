...
YARRAY = np.expand_dims(np.linspace(0.5, 2.5, NPDF), -1)*(1. + 0.1*np.random.uniform(size=(NPDF, NBIN)))
...
MEAN_MIXMOD = np.vstack([np.linspace(0.5, 2.5, NPDF), np.linspace(0.5, 1.5, NPDF), np.linspace(1.5, 2.5, NPDF)]).T
STD_MIXMOD = np.vstack([np.linspace(0.2, 1.2, NPDF), np.linspace(0.2, 0.5, NPDF), np.linspace(0.2, 0.5, NPDF)]).T
