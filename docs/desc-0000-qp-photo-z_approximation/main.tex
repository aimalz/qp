...
\texttt{scikit-learn}\footnote{\url{http://scikit-learn.org}} tools.
...
package\footnote{\url{http://trac.mystic.cacr.caltech.edu/project/pathos/wiki.ht
ml}}.  \citep{mckerns_building_2012, mckerns_pathos:_2010}
...
\begin{figure}
  \includegraphics[width=0.9\columnwidth]{figures/schmidt_pzs.png}
