...
original format.  \COMMENT{Review relative performance and absolute differences 
of metric values.}
...
Given the constraint that LSST will be able to store 200 floating point numbers 
to quantify the redshift of each galaxy and intends to include several \pz\ 
codes \COMMENT{Find the whitepaper to cite this, possibly put it in Sec 
\ref{sec:intro}.}, we can safely say that LSST can store the output of more 
than one \pz\ code without any significant risk of loss of information.
