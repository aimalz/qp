...
\begin{figure*}
  \begin{center}
    ...
    \caption{
    The means of the mean ($\pentagon$), variance ($\bigstar$), and kurtosis 
...
($\bigstar$), and kurtosis ($\APLstar$) of the \pz s for each dataset as a 
...
kurtosis ($\APLstar$) of the stacked estimator $hat{n}(z)$ of the redshift 
