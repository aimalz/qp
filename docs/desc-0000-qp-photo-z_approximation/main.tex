...
Some surveys store samples of a \pz, defining a .  \COMMENT{Cite upcoming DES 
paper.}  Samples are also the native output format of many machine learning 
...
grid as their native output format.  \COMMENT{Apparently BPZ does this because 
that's what Melissa and Sam gave me, but I don't have anything to cite saying 
this.}
